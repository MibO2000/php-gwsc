...
while ($row = $pitchQuery->fetch_array()) {
    $pitches[] = $row; // Append each row to the array
}
...
<body>
    <div class="flex justify-between flex-col min-h-screen">
        <main>
            <div class="hamburger-menu">
                ...
                <ul class="menu__box">
                    ...
                    <li><a class="menu__item mactive" href="/pitch">Pitch Types</a></li>
                    ...
                    <li><a class="menu__item flex items-center cursor-pointer pzero" href="/cart">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="profile-logo">
            ...
            <div>
                ...
                <div class="nav-bar disappear">
                    ...
                    <a class="active" href="/pitch">Pitch Types</a>
                        ...
                        <div>
                            <a href="/packages?pitch=<?= $pitch['pitch_name'] ?>">
                                <div class="info">
                                    ...
                                    <img class="w-full h-full" src="images/<?= $pitch['pitch_image'] ?>" alt="<?= $pitch['pitch_name'] ?>">
                                </div>
                            </a>
                        </div>
                    <?php } ?>
        ...
        <footer class="social-footer items-center">
            ...
            <div>
                <p class="text-center copyright">Pitch Type<br>© 2023, MibO.<br>All Rights Reserved.</p>
            </div>
