            ...
            <div class="container mx-auto heading-pa">
                <div class="pb-5">
                    <form class="form-field mpadding">
                        <div class="pb-5">
                            <input class="w-full pack-search" type="search" name="pack" placeholder="Search" value="<?php echo $_GET['pack'] ?? '' ?>">
                        </div>

                        <div class="grid grid-cols-3 gap-15">
                            <div>
                                <label for="pitch">Pitch</label>
                                <select class="w-full p-1-2" name="pitch" id="pitch">
                            ...
                            <div>
                                ...
                                <select class="w-full p-1-2" name="location" id="location">
                    ...
                    <?php foreach ($packages as $package) : ?>
                        <div class="grid grid-cols-2 package-card">
                            <div class='w-full h-full'>
                                <img class="w-full h-full object-cover object-center detail-thumbnail" src="images/<?= $package['package_image'] ?>">
                            </div>
                            <div class="detail">
                                <div>
