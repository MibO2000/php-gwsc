        ...
        <main>
            <div class="hamburger-menu">
                ...
                <ul class="menu__box">
                    ...
                    <li><a class="menu__item mactive" href="/local-attraction">Local Attraction</a></li>
                    ...
                    <div>
                        ...
                        <a href="/packages?location=<?= $local['location_name'] ?>">
                            <div class="info">
                                ...
                                <img class="w-full h-full" src="images/<?= $local['location_picture'] ?>"
                                    alt="<?= $local['location_name'] ?>">
                            </div>
                        </a>
                        <?php } ?>
                    </div>
