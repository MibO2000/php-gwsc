                ...
                <div class="flex flex-column">
                    <div class="w-full">
                        ...
                        <div class="grid grid-cols-2 py-5 place-items-center" style="gap:20px;padding-bottom:10px;">
                            <div>
                                <img class="w-full"
                                    src="https://images.unsplash.com/photo-1560439514-e960a3ef5019?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3270&q=80">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-2 py-5 place-items-center" style="gap:20px;padding-bottom:10px;">
                            ...
                            <div>
                                <img class="w-full"
                                    src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3270&q=80">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 py-5 place-items-center" style="gap:20px;padding-bottom:10px;">
                            <div>
                        ...
                        <div class="grid grid-cols-2 py-5 place-items-center" style="gap:20px;padding-bottom:10px;">
                            ...
                            <div>
                                <img class="w-full"
                                    src="https://images.unsplash.com/photo-1505373877841-8d25f7d46678?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3000&q=80">
                            </div>
                        </div>
                    </div>
                    <div class="rss-parent">
                        <div class="rss-feed rss-scroll">
                            ...
                            if (isset($wearArr->channel)) {
                                ...
                                echo "<p class='fz-'>" . $wearCha->description . "</p><br>";
